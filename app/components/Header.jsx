...
const Header = () => {
  ...
  const handleScroll = useCallback(() => {
    if(window.scrollY > (document.querySelector('section.header').clientHeight - document.querySelector('section.header').clientHeight/2))
      setSticky(true)
    else
      setSticky(false)
  }, [])
  ...
  return (
    ...
    {
      isOpen && (
        <div className="fixed z-[999] w-full inset-0 min-h-screen text-white bg-slate-600 bg-opacity-80 flex items-center justify-center">
          <button onClick={()=>{setOpen(!isOpen)}} className="block absolute z-[99] top-4 right-4">
